...
use Mailosaur\Models\EmailAddress;
...
class MailboxApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->client     = new MailboxApi($this->apiKey, $this->mailbox, $this->apiUrl);
    ...
    public function testGetEmailsBySearch()
    {
        ...
        $emails = $this->client->getEmails($second['subject']);
    ...
    public static function assertEmail($emailInfo, $email)
    {
        ...
        self::assertInstanceOf('\Mailosaur\Models\EmailAddress', $email->to[0]);
        self::assertInstanceOf('\Mailosaur\Models\EmailAddress', $email->from[0]);
        ...
        self::assertSame($emailInfo['text'], $email->text);
    ...
    public function testDeleteAllEmail()
    {
        $this->sendTestEmail();
        $this->sendTestEmail();
     ...
     * @depends testInitial
     */
    public function testGetRawEmail()
    {
        $first = $this->sendTestEmail();
        $this->sendTestEmail();
        ...
        self::assertNotEmpty($this->client->getRawEmail($emailsFiltered[0]->rawId));
    }
    ...
    public function createTestData()
    {
        ...
        $emailInfo = array(
            'from'        => new EmailAddress((object)array('address' => $faker->email, 'name' => $faker->name)),
            'to'          => new EmailAddress((object)array('address' => $this->useGenerateEmail ? $this->client->generateEmailAddress() : $faker->email, 'name' => $faker->name)),
